/* Minimal startup code for STM32H753 running under stm32-sim.
 * Cortex-M7 vector table + reset handler that copies .data from
 * flash to RAM, zeroes .bss, runs static constructors, then jumps
 * to main(). */
