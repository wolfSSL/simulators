/* stm32mp13xx_hal_conf.h - HAL config for the MP135 wolfCrypt build
 * under stm32-sim. Enable only the modules wolfSSL needs (RCC, RNG,
 * CRYP, HASH, PKA) plus the core bits the HAL touches at startup. */
